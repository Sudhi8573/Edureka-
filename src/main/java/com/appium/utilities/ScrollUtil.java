...
public class ScrollUtil {
	...
	public ScrollUtil(AndroidDriver<AndroidElement> driver)
	{
		this.driver=driver;
	}
	...
	public static void scrollToText(String text,AndroidDriver driver){
	     driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\""+text+"\"));");
	}
	
	public static void scrollToTextClick(String text,AndroidDriver driver){
